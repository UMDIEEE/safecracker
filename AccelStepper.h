...
public:
    ...
    void    setCurrentPosition(long position  /*, int reset */, int reset);  
...
private:
    ...
    /// Is this the first time calling setCurrentPosition()? If so, we'll also set the target position to 0
    bool 	_firstCall;
